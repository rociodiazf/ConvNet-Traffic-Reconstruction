function tracks = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TRACKS = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   TRACKS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   tracks = importfile('12_tracks.csv', 2, 1132882);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/09/30 12:36:27
